...
A mappában találunk egy ``conf'' mappát, amelyben a buildhez használt lokális
...
build/conf/local.conf fileban a machine változónak a ``raspberrypi4\-64'' értéket
...
$ FILES:\$\{PN\} += \"/usr/share/<csomagnév>/*\" $ \todo{ezt a vackot valahogy
  formázni}
